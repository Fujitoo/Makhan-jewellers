...
import { businessInfo, navLinks } from '@/data/mockData';
    ...
    <footer className="bg-slate-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold font-serif mb-4">{businessInfo.name}</h3>
            <p className="text-gray-400 text-sm mb-4">
              Crafting trust through generations. 100% BIS HUID Hallmarked jewellery since 1994.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href={`tel:${businessInfo.phone}`} className="text-gray-400 hover:text-gold-500 transition-colors text-sm">
                  {businessInfo.phone}
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-gold-500 flex-shrink-0" />
                <a href={`mailto:${businessInfo.email}`} className="text-gray-400 hover:text-gold-500 transition-colors text-sm">
                  {businessInfo.email}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">{businessInfo.hours}</span>
              </li>
